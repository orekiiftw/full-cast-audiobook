...
function isPendingStatus(status: Segment["status"]): boolean {
  return status === "pending" || status === "queued" || status === "processing" || status === "annotated";
}

function isPlayableSegment(seg: Segment | undefined): boolean {
        ...
        <div className="max-w-6xl mx-auto px-5 sm:px-6 h-full flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 sm:gap-5">
            ...
            <button
              ...
              className="w-12 h-12 rounded-full bg-gradient-to-b from-gold-300 to-gold-500 text-cinema-950 flex items-center justify-center shadow-glow-sm hover:scale-105 active:scale-95 transition-transform border border-gold-200/20"
        ...
        <div className="h-full flex flex-col p-5 sm:p-7 max-w-6xl mx-auto w-full animate-fade-in pt-6">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-5 pt-4 border-t border-white/[0.05]">
            ...
            <div className="flex items-center gap-5">
              ...
              <button
                onClick={togglePlayPause}
                className="w-14 h-14 rounded-full bg-gradient-to-b from-gold-300 to-gold-500 text-cinema-950 flex items-center justify-center shadow-glow hover:scale-105 active:scale-95 transition-transform border border-gold-200/20"
                aria-label={isPlaying ? "Pause" : "Play"}
              >
